<div class="content-page">
	<div class="row">
		<div class="small-12 columns">
            <h1>Blog - Categoria <%- category.get('title') %><% if(posts.getQuery()) { %> - Buscando por "<%- posts.getQuery() %>"<% } %></h1>
        </div>
	</div>
	<div class="row">
		<div class="small-12 columns">
            <ul class="breadcrumbs">
              ...
              <li<% if (!posts.getQuery()) { %> class="current"<% } %>><a href="<%- category.get('link') %>"><%- category.get('title') %></a></li>
